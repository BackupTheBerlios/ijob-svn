...
function PosEx_JOH_IA32_6(const SubStr, S: string; Offset: Integer = 1): Integer;
function PosEx_Sha_IA32_3(const SubStr, Str: string; Offset: integer=1): integer;
function PosEx_Sha_IA32_4(const SubStr, Str: string; Offset: integer=1): integer;
...
const
  ...
  FastcodePosExP4R: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastcodePosExP4N: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastcodePosExPMY: FastcodePosExFunction = PosEx_Sha_IA32_3;
  FastcodePosExPMD: FastcodePosExFunction = PosEx_Sha_IA32_3;
  FastcodePosExAMD64: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastcodePosExAMD64_SSE3: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastCodePosExIA32SizePenalty: FastCodePosExFunction = PosEx_Sha_IA32_4;
  FastcodePosExIA32: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastcodePosExMMX: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastCodePosExSSESizePenalty: FastCodePosExFunction = PosEx_Sha_IA32_4;
  FastcodePosExSSE: FastcodePosExFunction = PosEx_JOH_IA32_6;
  FastcodePosExSSE2: FastcodePosExFunction = PosEx_JOH_IA32_6;
